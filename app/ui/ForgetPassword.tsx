...
export default function ForgetPassword({ translate, setActiveForm }: any) {
  ...
  return (
    ...
    <div className="flex-1  bg-gray-50 px-6 pb-8 pt-8  flex-col gap-6 flex form_area rounded-[30px]  ">
      <TitleLoginHeading title="Forget password" />
      {
        activeOtpForm ? <OtpForm forget={true} translate={translate} useEmailOrPhone={useEmailOrPhone} formData={formData} user_info={user_info} /> :
